...
function CarouselGallery() {
  ...
  return (
    <div className='w-full h-screen m-auto pt-6 px-4 relative group bg-lightblue'>
        <h1 className='text-2xl font-semibold pb-4 font-mono text-center'>Image Gallery</h1>      
      <div
